...
class TerminalDePagamento{
    constructor(){
        ...
        this.pixBtn = document.createElement('button');
        this.pixBtn.disabled = 'true';
        this.pixBtn.classList = 'pixBtn';
        this.pixBtn.id = 'pixBtn';
        this.pixBtn.innerText = 'Pix';
        this.tela.appendChild(this.pixBtn)
